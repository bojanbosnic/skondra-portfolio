  ...
  return (
    <div className="flex flex-wrap md:justify-between md:flex-nowrap">
      <div className="text-xl w-full contact-card mr-0  md:w-[40%] md:mr-16">
        <span className="block text-2xl font-bold card-heading mb-0 leading-9 pt-0 md:pt-0 md:mb-5 text-left md:text-5xl  md:leading-[78px]">
          Contact
        </span>
        <span className="text-base  leading-8 md:leading-8 block mb-2.5 md:mb-5">
        ...
        <div className="bg-black px-0 py-0 md:py-5 border max-w-[210px] md:max-w-full border-white  mb-7 md:mb-0 rounded-xl">
          <div className="py-5">
            <span className="px-5 block text-2xl mb-1  font-bold head-quarter  md:leading-normal ">
              Head Quarter
            </span>
            <span className="block text-grey text-fadeWhite px-5 mt-1.5  text-sm md:mt-2.5 md:text-2xl">
        ...
        {success ? (
          ...
          <>
            ...
            <form
              ...
              className="w-full"
            >
              <div className="flex flex-wrap  md:pt-0 md:justify-between items-center w-full mb-1 md:mb-5 md:flex-nowrap">
                <div className="flex flex-col mb-2 contact-form-col">
                  <label className="mb-1 md:mb-1.5">Full Name</label>
                  <input
                    onChange={(e) =>
                ...
                <div className="flex contact-form-col mb-2 flex-col ">
                  <label className=" mb-1 md:mb-1.5">Email</label>
                  <input
                    type="email"
                    name="user_email"
                    className="placeholder:text-xs md:placeholder:text-sm lg:placeholder:text-base"
              ...
              <div className="flex form-btn-parent mt-5 pb-4 justify-center md:justify-end md:mt-8 md:pb-8">
                <button
                  type="submit"
